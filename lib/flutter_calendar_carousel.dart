...
import 'package:MAAPPE/src/calendar_header.dart';
import 'package:MAAPPE/src/classes/event.dart';
import 'package:MAAPPE/src/classes/event_list.dart';
import 'package:MAAPPE/src/classes/multiple_marked_dates.dart';
import 'package:MAAPPE/src/default_styles.dart';
import 'package:MAAPPE/src/weekday_row.dart';
...
class CalendarCarousel<T extends EventInterface> extends StatefulWidget {
  ...
  CalendarCarousel({
    ...
    this.iconColor = const Color.fromARGB(255, 21, 22, 22),
